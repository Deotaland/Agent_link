...
typedef enum {
    ...
    AGENT_EVT_PROMPT   = 4,    ///< Firmware-authored UTF-8 text; App forwards it verbatim to the Agent as a prompt. Single frame, not chunked — use agent_link_push_prompt().
    AGENT_EVT_CUSTOM   = 100,
} agent_event_t;
